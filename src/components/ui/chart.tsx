...
// Chart payload interfaces to reduce complex type checking
interface ChartPayloadBase {
  [key: string]: unknown;
}

interface ChartPayloadWithNested extends ChartPayloadBase {
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
  ...
  const chartPayload = payload as ChartPayloadWithNested;
  const payloadPayload = chartPayload.payload;

  let configLabelKey: string = key;

  if (key in chartPayload && typeof chartPayload[key] === "string") {
    configLabelKey = chartPayload[key] as string;
